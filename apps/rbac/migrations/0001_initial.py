        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="角色代碼"
                    ),
                ),
                ("name", models.CharField(max_length=100, verbose_name="角色名稱")),
                (
                    "role_name",
                    models.CharField(max_length=100, verbose_name="角色英文名稱"),
                ),
                (
                    "role_zh",
                    models.CharField(max_length=100, verbose_name="角色中文名稱"),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="權限代碼"
                    ),
                ),
                ...
                (
                    "method",
                    models.CharField(
                        blank=True, max_length=10, null=True, verbose_name="HTTP 方法"
                    ),
                ),
                (
                    "function_zh",
